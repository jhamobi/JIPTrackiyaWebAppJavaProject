...
public class TrackiyaWebApp implements EntryPoint {
	...
	private VehicleRegWebPage vehicleRegWebPage;
	...
	void InitView() {
		...
		//tabPanel.add(InitMapWebPage(), "Map");
	...
	private VerticalPanel InitVehicleRunningStatusWebPage() {
	...
	private VerticalPanel InitVehicleRegistrationWebPage() {
		vehicleRegWebPage = new VehicleRegWebPage();
		return vehicleRegWebPage.InitVehicleRegistrationWebPage();
	}
...
//	private MapWidget InitMapWebPage() {
//		MapWebPage r = new MapWebPage();
//		return r.InitMapWebPage();
//	}
	...
	public class GetAllHubsServiceCallback implements AsyncCallback<List<Hub>> {
		...
		public void onSuccess(List<Hub> result) {
			...
			if (vehicleRegWebPage != null)
				vehicleRegWebPage.refreshData();
