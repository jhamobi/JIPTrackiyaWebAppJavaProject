...
public class VehicleRunStatusWebPage {
	...
	public VerticalPanel InitVehicleRunStatusWebPage() {
		...
		TextColumn<VehicleRunStatus> timeTravelled = new TextColumn<VehicleRunStatus>() {
			...
			public String getValue(VehicleRunStatus object) {
				...
				if (vehicleTimeLapsed == null || vehicleTimeLapsed.trim().isEmpty())
					...
					Long valueOf = null;
					try {
						valueOf = Long.parseLong(vehicleTimeLapsed);
		...
		Button bMap = new Button("Hello");
		bMap.addClickHandler(new ClickHandler() {

			@Override
			public void onClick(ClickEvent event) {
				LatLng somewhereInTexas = LatLng.newInstance(37.0625,-95.677068);

				final MapWidget map = new MapWidget(somewhereInTexas, 2);
	...
	// }
	//
	// public final native String InitMapWebPage() /*-{
	// var map;
	// function initMap() {
