				...
				try {
					if (id != null) {
						...
						if (v != null) {
								...
								jsonResponse.put(TrackiyaDBTableColumnNames.LATITUTE, v.getHub().getLatitude());
								jsonResponse.put(TrackiyaDBTableColumnNames.LONGITUDE, v.getHub().getLongitude());
								jsonResponse.put(TrackiyaDBTableColumnNames.CITY, v.getHub().getCity());
								jsonResponse.put(TrackiyaDBTableColumnNames.ADDRESS, v.getHub().getAddress());
								jsonResponse.put(TrackiyaDBTableColumnNames.ZONE, v.getHub().getZone());
